...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className='text-center text-6xl font-bold text-black'>
        <h1 className='mt-16 mb-20'>Jogo da Veia</h1>
        <table className='flex justify-center text-center transform transition duration-200'>
          <tbody>
            <tr>
              <td onClick={() => jogar(0)} className='border-4 border-white w-[100px] h-[100px] hover:bg-white hover:text-black'>{jogoDaVelha[0]}</td>
            ...
            <tr>
              <td onClick={() => jogar(6)} className='border-2 sborder-white w-[100px] h-[100px] hover:bg-white hover:text-black'>{jogoDaVelha[6]}</td>
        ...
        <button onClick={() => zerarJogo()} className='mt-10 border-2 bg-white text-black w-[175px] h-[70px] text-lg rounded-full hover:bg-black hover:border-white hover:text-white'>Try again!</button>
